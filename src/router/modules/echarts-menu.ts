const echartsMenu: AuthRoute.Route = {
    ...
    children: [
            ...
            children: [
                {
                    ...
                    meta: {
                        title: '中国地图',
                        i18nTitle: 'message.routes.echarts-menu.map-view.china',
                        requiresAuth: true,
                    },
                },
                {
                    ...
                    meta: {
                        title: '广东地图',
                        i18nTitle: 'message.routes.echarts-menu.map-view.guangdong',
                        requiresAuth: true,
                    },
                },
                {
                    ...
                    meta: {
                        title: '宁夏地图',
                        i18nTitle: 'message.routes.echarts-menu.map-view.ningxia',
                        requiresAuth: true,
                    },
                },
            ],
        ...
        {
            name: 'echarts-menu_pie3d',
            path: '/echarts-menu/pie3d',
            component: 'self',
            meta: { title: '3d圆环图', i18nTitle: 'message.routes.echarts-menu.pie3d._value', requiresAuth: true },
        },
        {
