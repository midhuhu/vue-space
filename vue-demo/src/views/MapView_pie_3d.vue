<template>
    <div class="echarts">
        <echarts-api :options="option"></echarts-api>
    </div>
</template>
...
const getParametricEquation = (startRatio: number, endRatio: number, isSelected: boolean, isHovered: boolean, k: number,height: number) => {
